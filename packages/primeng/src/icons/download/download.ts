...
@Component({
    ...
    template: `
        ...
        <svg:path d="M12,15.75a.74.74,0,0,1-.53-.22l-4-4a.75.75,0,0,1,1.06-1.06L12,13.94l3.47-3.47a.75.75,0,0,1,1.06,1.06l-4,4A.74.74,0,0,1,12,15.75Z" fill="currentColor" />

...
@Component({
    ...
    template: `
        <svg:path
            ...
            fill="currentColor"
        />
        <svg:path d="M12,16.25A3.25,3.25,0,1,1,15.25,13,3.26,3.26,0,0,1,12,16.25Zm0-5A1.75,1.75,0,1,0,13.75,13,1.76,1.76,0,0,0,12,11.25Z" fill="currentColor" />
    `
})

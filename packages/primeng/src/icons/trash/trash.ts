...
@Component({
    ...
    standalone: true,
    template: `
        <svg:path d="M20,8.7H4A.75.75,0,1,1,4,7.2H20a.75.75,0,0,1,0,1.5Z" fill="currentColor" />
        <svg:path
            ...
            fill="currentColor"
        />
        <svg:path d="M10.22,17a.76.76,0,0,1-.75-.75V11.72a.75.75,0,0,1,1.5,0v4.52A.75.75,0,0,1,10.22,17Z" fill="currentColor" />
        <svg:path d="M13.78,17a.75.75,0,0,1-.75-.75V11.72a.75.75,0,0,1,1.5,0v4.52A.76.76,0,0,1,13.78,17Z" fill="currentColor" />
    `
})

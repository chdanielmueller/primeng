...
@Component({
    selector: '[data-p-icon="calendar-minus"]',
    standalone: true,
    template: `
        <svg:path
            ...
            fill="currentColor"
        />
        <svg:path d="M14,15.3H10a.75.75,0,0,0,0,1.5h4a.75.75,0,0,0,0-1.5Z" fill="currentColor" />
    `
})
export class CalendarMinusIcon extends BaseIcon {}

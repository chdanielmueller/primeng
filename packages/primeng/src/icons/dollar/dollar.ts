...
@Component({
    selector: '[data-p-icon="dollar"]',
    standalone: true,
    template: `
        <svg:path d="M12,20.75a.76.76,0,0,1-.75-.75V4a.75.75,0,0,1,1.5,0V20A.76.76,0,0,1,12,20.75Z" fill="currentColor" />
        <svg:path
...
export class DollarIcon extends BaseIcon {}

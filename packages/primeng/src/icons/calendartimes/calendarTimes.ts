...
@Component({
    selector: '[data-p-icon="calendar-times"]',
    standalone: true,
    template: `
        <svg:path
        ...
        />
        <svg:path
            d="M13.94,14.06a.74.74,0,0,0-1.06,0l-.88.88-.88-.88a.75.75,0,0,0-1.06,1.06l.88.88-.88.88a.74.74,0,0,0,0,1.06.71.71,0,0,0,.53.22.74.74,0,0,0,.53-.22l.88-.88.88.88a.74.74,0,0,0,.53.22.71.71,0,0,0,.53-.22.74.74,0,0,0,0-1.06L13.06,16l.88-.88A.74.74,0,0,0,13.94,14.06Z"
            fill="currentColor"
        />
    `
})
export class CalendarTimesIcon extends BaseIcon {}

...
@Component({
    selector: '[data-p-icon="eye-slash"]',
    standalone: true,
    template: `
        <svg:path
            d="M20.69,11.7c-.12-.26-2.86-6.45-8.69-6.45a7.67,7.67,0,0,0-1.66.18.75.75,0,0,0,.32,1.46A6.62,6.62,0,0,1,12,6.75c4.18,0,6.58,4.1,7.17,5.25a13.28,13.28,0,0,1-1.26,2,.75.75,0,0,0,.59,1.21.75.75,0,0,0,.59-.29,13.42,13.42,0,0,0,1.6-2.59A.78.78,0,0,0,20.69,11.7Z"
            fill="currentColor"
        />
        <svg:path

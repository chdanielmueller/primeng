...
@Component({
    selector: '[data-p-icon="money-bill"]',
    standalone: true,
    template: `
        <svg:path
            ...
            fill="currentColor"
        />
        <svg:path d="M12,8.5A3.5,3.5,0,1,0,15.5,12,3.5,3.5,0,0,0,12,8.5ZM12,14a2,2,0,1,1,2-2A2,2,0,0,1,12,14Z" fill="currentColor" />
    `
})
export class MoneyBillIcon extends BaseIcon {}
